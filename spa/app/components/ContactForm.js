export function contactForm() {
  ...
  let $style = d.getElementById("dynamic-styles");
  ...
  $form.innerHTML = `<legend>Envianos tus Comentarios</legend>
      <input type="text" name="name" placeholder="Escribe tu Nombre" title="Nombre solo acepta letra y espacios en blanco" pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\\s]+$" required />
      ...
      <textarea name="comments" cols="50" rows="5" placeholder="Escribe tus comentarios" title="Tus comentarios no deben exceder los 255 caracteres"
  ...
  function validationsForm() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/rogab01@gmail.com", {
        method: "POST",
        ...
        .then((json) => {
          ...
          $response.innerHTML = `<p> ${jsom.message}</p>`;
          $form.reset();
        })
        .catch((err) => {
          console.log(err);
